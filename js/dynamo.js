...
;(function ( $, window, document, undefined ) {
    ...
    Plugin.prototype = {
        init: function() {
            ...
            this.wrapper.children(".page").not('.active').css({'left':this.width});
        ...
        resize:function(){
            this.wrapper.children(".page.active").css({"left":0});
            this.wrapper.children(".page").not('.active').css({"left":-this.wrapper.width()});
        },
